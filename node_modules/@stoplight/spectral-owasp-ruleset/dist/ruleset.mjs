...
var checkSecurity_default = createRulesetFunction(
  {
    input: null,
    options: {
      type: "object",
...
// src/functions/differentSecuritySchemes.ts
import {
  createRulesetFunction as createRulesetFunction2
} from "@stoplight/spectral-core";
var getAllOperations2 = function* (paths) {
  if (typeof paths !== "object") {
    return;
  }
  const validMethods = [
...
var differentSecuritySchemes_default = createRulesetFunction2(
  {
    input: null,
    options: {
      type: "object",
  ...
  function differentSecuritySchemes(input, options) {
    ...
    const { paths } = input;
    for (const { path, operation: httpMethod } of getAllOperations2(paths)) {
      let { security: operationSecurity } = paths[path][httpMethod];
      if (operationSecurity === void 0) {
        continue;
      }
...
var ruleset_default = {
  ...
  rules: {
    ...
    "owasp:api3:2023-constrained-unevaluatedProperties": {
      ...
      severity: DiagnosticSeverity.Warning,
      formats: [oas3_1],
      given: '$..[?(@ && @.type=="object" && @.unevaluatedProperties &&  @.unevaluatedProperties!=true &&  @.unevaluatedProperties!=false )]',
      then: [
        {
          field: "maxProperties",
          function: defined
    ...
    "owasp:api5:2023-admin-security-unique": {
      ...
      then: [
        {
          function: differentSecuritySchemes_default,
          functionOptions: {
            adminUrl: "/admin"
          }
        }
